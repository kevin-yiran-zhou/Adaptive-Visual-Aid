...
public class PorcupineService extends Service {
    ...
    private final PorcupineManagerCallback porcupineManagerCallback = (keywordIndex) -> {
        ...
        Intent wakeIntent = new Intent("com.example.adaptivevisualaid.WAKE_WORD_DETECTED");
...
//                    .setKeywordPath("Hey-Ava_en_android_v3_0_0.ppn")
            ...
            Log.d("PorcupineService", "Hey Ava PorcupineManager started successfully");
        ...
        Notification notification = porcupineManager == null ?
                ...
                getNotification("Wake word service", "Say 'Hey Ava'!");
    ...
    private void onPorcupineInitError(String message) {
        Log.e("PorcupineService", "Hey Ava Porcupine init error: " + message);
